                    ...
                    <div class="col-md-7">
                        ...
                        <div class="pesan text-center">
                            <div class="alert alert-success alert-dismissible fade show col-md-12" role="alert">
                                Masukkan password baru akun <span style="font-style: italic">Srikandi Semanggi</span> anda
                            </div>
                        </div>
                        <form action="" method="post">
                            ...
                            <div class="pt-1 mt-3 mb-4 d-flex justify-content-center text-center">
                                <button class="btn btn-success btn-lg btn-block" style="padding: 10px 100px 10px 100px" type="submit">Reset Password</button>
                            </div>
                        </form>
                    </div>
                </div>
