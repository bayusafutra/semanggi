...
@section('erga')
    <div class="title mb-4">
        <h1 class="text-center" style="font-family:courier new; font-style: initial;">Tambah Metode Pembayaran Srikandi Semanggi</h1>
    </div>
    {{-- Start Form --}}
        ...
        <div class="col-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/dash-tambahmetodepembayaran" method="POST" enctype="multipart/form-data" class="forms-sample">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nomer') is-invalid @enderror" name="nomer" id="nomer" placeholder="Nomer rekening" required value="{{ old('nomer') }}"/>
                            @error('nomer')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            font-weight: 400; color: #495057; border-radius: 2px"
                                    placeholder="Upload Image" value="{{ old('logo') }}" required>
                            </div>
                            @error('logo')
                                <div class="invalid-feedback">
                                    {{ $message }}
