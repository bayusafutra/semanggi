                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-start">
                        <div class="col-lg-6" style="padding-left: 30px">
                            <strong>Jumlah Pesanan : {{ $audit->count() }}</strong>
                        </div>
                    </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content"
                                                ...
                                                <form action="/dash-tolakaudit" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="bodi">
                                                            <label for="">Berikan alasan mengapa Anda menolak pembayaran pesanan ini!</label>
                                                            <input type="text" style="background-color: rgb(205, 205, 205); color: black" name="pesantolak" class="form-control mt-3" required>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-light" data-bs-dismiss="modal"
